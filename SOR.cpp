...
#include "Images/SOR_WxToolButton5_XPM.xpm"
#include "Images/SOR_WxToolButton3_XPM.xpm"
#include "Images/SOR_WxToolButton2_XPM.xpm"
#include "Images/SOR_WxToolButton1_XPM.xpm"
#include "Images/SOR_WxToolButton7_XPM.xpm"
////Header Include End
...
void SOR::CreateGUIControls()
{
	...
	WxToolBar1 = new wxToolBar(this, ID_WXTOOLBAR1, wxPoint(0, 0), wxSize(863, 40), wxTB_TEXT);

	wxBitmap WxToolButton7_BITMAP (SOR_WxToolButton7_XPM);
	...
	wxBitmap WxToolButton1_BITMAP (SOR_WxToolButton1_XPM);
	...
	wxBitmap WxToolButton2_BITMAP (SOR_WxToolButton2_XPM);
	...
	wxBitmap WxToolButton3_BITMAP (SOR_WxToolButton3_XPM);
	...
	wxBitmap WxToolButton5_BITMAP (SOR_WxToolButton5_XPM);
